...
var createScene = async function () {
    ...
    intento.onPointerClickObservable.add(function () {pley=true;
        if(gana){datos= "ganaste.php?ip="+dir+ "&premio=" +premio+"&code="+ramdom;
        }else{datos= "normal.html?ip="+dir+ "&premio=" +"CascoZR"+"&code="+ramdom;
        }
        enviar(datos);
    });
    ...
    var segundo = window.setInterval(() => {
        ...
        if (tiempo === 15) {
            if (ramdom1 === ramdom2 && ramdom1 === ramdom3) {
                ...
                switch (ramdom1) {
                    case 1: console.log("Guantes"); premio="Guantes Shaft"; break;
                    case 2: console.log("Intercom");premio="Intercom Ultra X2"; break;
                    case 3: console.log("Candado 512");premio="Candado BT 512"; break; // hay dos tipos 512 y 513
                    case 4: console.log("Maletero");premio="Maletero Shad"; break;
                    case 5: console.log("Casco");premio="Casco Integral NZ1"; break;
                    case 6: console.log("Bono Exito");premio="Bono Exito Mercado OnLine"; break;
                    case 7: console.log("netflix");premio="Netflix 53 días 1 pantalla"; break;
                    case 8: console.log("recarga celu");premio="Nequi Daviplata 10k"; break; // dos recargas de 10 y de 5
                    case 9: console.log("bono cagu");premio="Bono Rappi-Cangú"; break;
                    case 10:console.log("Candado 514");premio="Candado BT 514 bullet"; break;
                    case 11:console.log("bono cagu");premio="Recarga Nequi/DavidPlata 5K"; break;
