...
$query = "UPDATE jugadores set intento = ? where id = ?";
$stmt =  mysqli_prepare($dblink, $query);
mysqli_stmt_bind_param($stmt, 'ss', $cuantos, $id);

$stmt->execute();
$stmt->close();

    
$query =mysqli_query($dblink, "SELECT * FROM productoss where id ='$premio' and cantidad > 0 ") or die(mysqli_error($dblink));
...
if($cantidad>0){
    ...
    echo "Actualizado! ".$id." cantidad ".$cantidad ;
...
<body>
    ...
    <script>
        ...
        var intRest = "<?php echo $cuantos; ?>";
        var canti; //"<?php echo $cuantos; ?>";
        var dir = "<?php echo $dir; ?>";
        var id = "<?php echo $id; ?>";
        var ramdom ="<?php echo $premio ?>"
       // var ramdom = 25;
        console.log(ramdom);
        // console.log(dir, "aca");
        var rotar1 = 0;
        ...
        */
        ...
        var salvar=false;
            function guardarDesconteo(){
               ...
               // salvar=true;
                let ide = <?php echo $id ?>;
                let cantiloco = <?php echo  $cantidad ?>;
                console.log(ide, cantiloco," aca estamos");
