...
<body  onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
    ...
    <!--===<p class="letras_text">&nbsp<?php echo $_GET['premio'];?></p>====-->
                ...
                <div class="elemento">
                    ...
                    <form action="uploadok.php" method="POST" enctype="multipart/form-data">
                        ...
                        <span class="letras_info">
                            REGISTRA TUS DATOS Y UN ASESOR SE COMUNICARÁ PARA 
                            ENTREGAR TU PREMIO EN LOS PRÓXIMOS 30 DÍAS. ADJUNTA 
                            UNA FOTO DE LA FACTURA PARA HACER VÁLIDO EL PREMIO Y 
                            PARTICIPA EN EL SORTEO DE UNA MOTO HONDA CB190R TRICOLOR.<br>
                        ...
                        <table>
                            <tr>
                                ...
                                <td><label for="nombre"></label>
                                    <input style="width: 15em" name="nombre" type="text" id="nombre" required>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left"><label for="nombre"></label>
                                    <input style="width: 15em" name="documento" type="number" id="documento" required>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left"><label for="nombre"></label>
                                    <input style="width: 15em" name="ciudad" type="text" id="ciudad" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td align="left"><label for="nombre"></label>
                                    <input style="width: 15em" class="numero" name="celular" type="number" id="celular"
                                        required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p class="letras_text">E-MAIL</p>
                                </td>
                                <td align="left"><label for="nombre"></label>
                                    <input style="width: 15em" name="email" type="email" id="email" required>
                                </td>
                            </tr>

                            <tr>
                                <td NOWRAP>
                                    <p class="letras_text">MARCA DE MOTO</p>
                                </td>
                                <td align="left"><label for="nombre"></label>
                                    <input style="width: 15em" name="moto" type="text" id="moto" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td align="left"><label for="nombre"></label>
                                    <input style="width: 15em" name="kilometraje" type="number" id="kilometraje"
                                        required>
                                </td>
                        ...
                        <tr>
                            ...
                            <div><input style="display: none" size="22px" name="premio" type="text" id="premio" readonly
                                    value="<?php echo $_GET['premio'];?>"></div>
                        </tr>
                        <tr>
                            <p class="letras_text2" style="display: none">No </p>
                            <div><input style="display: none" size="22px" name="code" type="text" id="code" readonly
                                    value="<?php echo $_GET['code'];?>"></div>
                        </tr>
                        <tr>
                            <p class="letras_text2" style="display: none">No </p>
                            <div><input style="display: none" size="22px" name="ip" type="text" id="ip" readonly
                                    value="<?php echo $_GET['ip'];?>"></div>
                        </tr>
                        <span>
                        </span>
                        <span class="image">
                        ...
                        <label class="politica">
                            <strong onclick="ubicar()"><a href="">Políticas y Términos</a></strong>
                        </label>
                        ...
                        <span>
                            <input style="float: left" type="submit" name="submit" value="ENVIAR"
        ...
        <div class="window-notice" id="window-notice" style="overflow-y:auto;">
                            <div class="content">
                                <div class="content-text">
                                    ...
                                    <strong>REGLAMENTO DE TERMINOS Y CONDICIONES DEL JUEGO PROMOCIONAL “COMPRA, INSCRÍBITE Y GANA”</strong><br><br>

                       

                        1. Todas las personas en cualquier lugar de Colombia que compren lubricante AGH podrán participar para ganar premios con el “compra, inscribirte y gana” y adicional participar por el sorteo de una moto HONDA CB190R TRICOLOR Modelo 2021. Esto aplica para las compras validas de lubricante AGH, por cada producto comprado una persona tiene la posibilidad de jugar una sola vez con la factura correspondiente que demuestre la compra del mismo, fraudes detectados como varios intentos de juego con el mismo código o el uso indebido de las facturas en mas de un registro, será causal de anulación y cancelación del participante y no se hará entrega de ningún premio, la marca se reserva el derecho de notificar a la persona este hecho de fraude.<br>
                        ...
                        8.Uno de nuestros asesores se estará comunicando en los próximos 30 días despues de participar para confirmar sus datos personales y la legalidad de la factura adjunta para poder hacer entrega del
                        ...
                        sorteo.<br>
                        10. En caso de que la factura no sea legible en la foto o no corresponda a compras reales de lubricantes AGH, automáticamente será eliminado de los ganadores de premios o concursantes para el sorteo de la moto CB190R TRICOLOR Modelo 202
                        <br><br>
                        ...
                        eventos & publicidad SAS comunicará telefónicamente Si no fuere localizado o no cumple con los requisitos reglamentarios
                        para recibir el premio, de dicha circunstancia se dejará constancia en el acta de anulación de la
                        ...
                        organismo de transito correspondiente, ya que de otra manera no podrá ser entregado el premio.<br>
                        ...
                        <strong>CONDICIONES Y RESTRICCIONES PARA PARTICIPAR DEL JUEGO PROMOCIONAL “COMPRA, INSCRÍBETE Y GANA”</strong><br>
                        ...
                        así mismo, podrá solicitar la supresión o revocar la autorización otorgada para su tratamiento.<br><br>
                        ...
                        <br><br>
                                ...
                                <div class="content-buttons"><a href="#" id="close-button" style="color:#FF0000"
                                        onclick="ubicar()"><strong>CONTINUAR</strong> </a></div>
                            </div>
                        </div>
    </div>
